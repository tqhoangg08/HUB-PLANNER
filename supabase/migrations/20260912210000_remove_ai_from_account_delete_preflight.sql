-- AI chat logs and AI document metadata are retained as historical source
-- data after their authority moves to D1/R2. Account deletion must no longer
-- depend on either source table being writable.
