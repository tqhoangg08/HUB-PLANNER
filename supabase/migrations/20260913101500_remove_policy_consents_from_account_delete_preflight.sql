-- Prepared for the policy-consent D1 cutover. This is intentionally not
-- applied by CI; the operator applies it only after the D1 data migration
-- has passed its owner-mapping and parity preflight.
