...
const App: React.FC = () => {
    ...
    // --- OPTIMIZED FUNCTIONS (USE CALLBACK) ---
    ...
    const updateSemester = useCallback((index: number, updatedSem: Semester) => {
        setData(prev => {
            const newSemesters = [...prev.semesters];
            // Shallow compare to prevent update if nothing changed
            if (JSON.stringify(newSemesters[index]) !== JSON.stringify(updatedSem)) {
                ...
                <div className="p-6 space-y-6">
                    ...
                    <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 flex gap-3 items-start text-sm text-orange-800">
                        ...
                        <div className="space-y-2">
                            <p>
                                <strong>Lưu ý quan trọng: HIỆN TẠI TÍNH NĂNG NHẬP BẢNG ĐIỂM ĐANG GẶP TRỤC TRẶC LỖI MỘT XIUSUU, NÊN MỌI NGƯỜI TẠM THỜI NHẬP TAY THỦ CÔNG GIÚP MÌNH NHENNN. TÍNH NĂNG SẼ SỚM QUAY TRỞ LẠI</strong> 
                            </p>
                            <p>
                            </p>
                        </div>
