             ...
             <div className="h-10 w-10 relative flex-shrink-0 group cursor-pointer transition-transform duration-300 hover:scale-110 active:scale-95" onClick={playClick}>
                <img 
                    ...
                    onError={(e) => {
                        ...
                        e.currentTarget.parentElement!.innerHTML = '<div class="h-12 w-12 bg-[#003375] rounded flex items-center justify-center text-white font-bold text-xs shadow-md">HUB</div>';
                    }}
                />
             </div>
             <div>
