...
const App: React.FC = () => {
  ...
  const shouldShowProtectedApp = Boolean(session) || userRolePref === 'student';

  return (
    <Routes>
      <Route path="/privacy" element={<PrivacyPolicy />} />
      <Route path="/terms" element={<TermsOfUse />} />
      <Route path="/login" element={<LoginScreen onBack={handleBackToRoleSelection} mode={loginMode} />} />
      <Route
        path="/"
        element={shouldShowProtectedApp ? renderProtectedApp() : <RoleSelection onSelect={handleRoleSelect} />}
      />
