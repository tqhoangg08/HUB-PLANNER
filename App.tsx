...
const App: React.FC = () => {
    ...
    useEffect(() => {
        const ensureSchoolDomain = async () => {
            ...
            if (emailDomain !== SCHOOL_DOMAIN) {
                // Security Hardening: Block access immediately
                setIsAccessDenied(true);
                // logout logic is handled by user action in AccessDenied screen or auto
            } else {
    ...
    const renderProtectedApp = () => {
        ...
        // Security Barrier: Access Denied Screen
        if (isAccessDenied && userRolePref === 'school') {
            return (
                <div className="min-h-screen flex flex-col items-center justify-center p-6 bg-gray-50 animate-fadeIn">
                    <div className="bg-white p-8 rounded-2xl shadow-xl max-w-md text-center border-t-4 border-red-600">
                        <div className="w-20 h-20 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-6">
                            <Shield className="text-red-600" size={40} />
                        </div>
                        <h2 className="text-2xl font-bold text-gray-900 mb-2">Truy cập bị từ chối</h2>
                        <p className="text-gray-600 mb-6">
                            Hệ thống phát hiện bạn đang sử dụng tài khoản email:
                            <br />
                        ...
                        <button
                            ...
                            className="w-full bg-[#003375] text-white font-bold py-3 rounded-xl hover:bg-[#002855] transition-all flex items-center justify-center gap-2 shadow-lg hover:shadow-xl hover:-translate-y-1"
                        >
