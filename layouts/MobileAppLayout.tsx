...
export const MobileAppLayout: React.FC<MobileAppLayoutProps> = ({
  ...
  return (
    <div className={`mobile-app-root app-root platform-${platform} ${mobileRouteClass} flex flex-col h-[100dvh] w-screen min-w-[100dvw] max-w-none relative pb-safe bg-white z-10 overflow-hidden`}>
