...
const guideItems: GuideItem[] = [
    ...
    },
    {
        ...
        bg: 'bg-violet-50',
        summary: 'Dùng để gửi thông tin mất đồ, nhặt được đồ hoặc yêu cầu hỗ trợ tìm lại đồ thất lạc cho Ban quản trị.',
        useFor: [
            'Gửi thông tin khi mất thẻ sinh viên, ví, chìa khóa, tai nghe, laptop hoặc giấy tờ.',
            'Tìm tin theo khu vực nhặt được, loại đồ và thời gian.',
            'Liên hệ theo thông tin đã được Ban quản trị duyệt để xác nhận đồ trước khi nhận lại.',
        ],
        steps: [
            'Vào Tìm đồ thất lạc, chọn gửi thông tin nhặt/mất đồ cho Ban quản trị.',
            'Ghi rõ món đồ, màu sắc, đặc điểm nhận dạng và khu vực liên quan.',
            'Thêm ảnh nếu có để Ban quản trị kiểm tra và hỗ trợ hiển thị chính xác hơn.',
            'Khi đã tìm được hoặc trả lại đồ, gửi yêu cầu cập nhật trạng thái cho Ban quản trị.',
        ],
        tips: [
            'Không gửi thông tin quá riêng tư như số giấy tờ đầy đủ.',
            'Khi nhận đồ, nên mô tả được đặc điểm riêng để tránh nhận nhầm.',
            'Tin càng rõ khu vực và thời gian thì càng dễ tìm lại.',
        ],
        cta: 'Mở danh sách hỗ trợ',
        path: '/lost-found',
    },
    {
