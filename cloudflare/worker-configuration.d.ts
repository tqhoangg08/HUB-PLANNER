/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=cloudflare\wrangler.jsonc cloudflare\worker-configuration.d.ts` (hash: 96d6d8a27fbd2804a3ddc337c5d2e3f7)
// Runtime types generated with workerd@1.20260722.1 2026-07-29 
interface __BaseEnv_Env {
	DB: D1Database;
	ALLOWED_ORIGINS: "http://localhost:3000,http://localhost:5173,https://hotrosinhvienhub.id.vn";
